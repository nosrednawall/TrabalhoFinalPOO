...
public class PixelRGB {
	...
	public static PixelRGB gris(int v) { // resultado: un pixel gris de
											// intensidad v
	...
	public int getR() {
		return r;
	} // resultado: la componente roja de this

	public int getG() {
		return g;
	} // resultado: la componente verde de this

	public int getB() {
		return b;
	} // resultado: la componente azul de this
